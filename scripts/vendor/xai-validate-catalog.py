#!/usr/bin/env python3
# Vendored from xai-org/plugin-marketplace (scripts/validate-catalog.py).
# Run against a tree that contains ONLY .grok-plugin/marketplace.json
# (Claude catalogs intentionally omit sha — dual regime).
